---
title: "Declarative MVC via Jotai & React"
...
MVC isn't a network boundary abstraction; instead it's a means of more generally
...
Part of what makes Jotai effective as a model layer is the global nature of
atoms, and the fact that you can create entire hierarchies of derived,
auto-updating data. We sort of use the semantics of a spreadsheet - update one
value, and you can watch all dependent values update in a cascade.
